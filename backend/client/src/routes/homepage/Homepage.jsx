        ...
        <>
            ...
            <section className='two'>
                <div className="whole">
                    <div className="container-1">
                        ...
                        <div className="right">
                            <img src="./sect-2-img.jpg" alt="Section 2 Image 1" />
                        </div>
                    </div>

                    <div className="container-2">
                        <div className="left">
                            <img src="./sect-2-img2.jpg" alt="Section 2 Image 2" />
                        </div>
                        <div className="right">
                            <hr />
            ...
            <section className='three' id='features'>
                ...
                <div className="about2">
                    <div className="left">
                        <img src="./img1.jpg" alt="Minimalistic Interface" />
                    </div>
                    <div className="right">
                ...
                <div className="about3">
                    ...
                    <div className="right">
                        <img src="./img2.jpg" alt="AI-Powered Chatbot" />
                    </div>
                </div>
            </section>
